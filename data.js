  ...
  const DATA = {
    ...
    waves: [
...

      {
        ...
        name: "동굴 박쥐",
        reward: 25,
        recommendation: "비행 적은 궁수와 번개가 유리합니다.",
        groups: [
          {
            type: "slime",
            count: 7,
...

      {
        ...
        name: "늪지 무리",
        reward: 38,
        recommendation: "대포 광역 피해가 효과적입니다.",
        groups: [
          {
            type: "slime",
            count: 12,
...

      {
        ...
        name: "하늘과 늑대",
        reward: 42,
        recommendation: "궁수와 얼음 조합이 안정적입니다.",
        groups: [
          {
            type: "bat",
            count: 12,
...

      {
        ...
        name: "역병의 발소리",
        reward: 46,
        recommendation: "번개와 대포로 빠르게 처리하세요.",
        groups: [
          {
            type: "plagueCrawler",
            count: 9,
...

      {
        ...
        name: "깊은 균열",
        reward: 60,
        recommendation: "재생 적을 화력으로 빠르게 제거하세요.",
        groups: [
          {
            type: "slime",
            count: 14,
...

      {
        ...
        name: "그림자 기동대",
        reward: 64,
        recommendation: "독성 또는 대포가 유리합니다.",
        groups: [
          {
            type: "bat",
            count: 12,
...

      {
        ...
        name: "골렘 행진",
        reward: 70,
        recommendation: "중장갑 대응 화력을 준비하세요.",
        groups: [
          {
            type: "golem",
            count: 10,
...

      {
        ...
        name: "사제의 의식",
        reward: 76,
        recommendation: "번개 연쇄와 히어로 스킬이 좋습니다.",
        groups: [
          {
            type: "darkPriest",
            count: 12,
...

      {
        ...
        reward: 108,
        boss: true,
        recommendation: "보스 특화 대포를 준비하세요.",
        groups: [
          {
            type: "shadowKnight",
            count: 9,
...

      {
        ...
        name: "검은 파도",
        reward: 86,
        recommendation: "광역과 연쇄 공격이 중요합니다.",
        groups: [
          {
            type: "slime",
            count: 18,
...

      {
        ...
        name: "오염된 강철",
        reward: 92,
        recommendation: "히어로 스킬을 적극 사용하세요.",
        groups: [
          {
            type: "plagueCrawler",
            count: 12,
...

      {
        ...
        name: "타락한 성직자",
        reward: 100,
        recommendation: "얼음 냉기형과 번개가 좋습니다.",
        groups: [
          {
            type: "darkPriest",
            count: 14,
...

      {
        ...
        name: "마지막 방어선",
        reward: 115,
        recommendation: "대포·독성·히어로 화력이 필요합니다.",
        groups: [
          {
            type: "golem",
            count: 12,
...

      {
        ...
        reward: 260,
        boss: true,
        recommendation: "유물과 모든 스킬을 활용하세요.",
        groups: [
          {
            type: "darkPriest",
            count: 10,
    ...
    formulas: {
      ...
      towerSellValue(tower, level) {
        return Math.floor(
          DATA.formulas.towerInvestedGold(
            tower,
            level
          ) * 0.65
        );
